...
bool DirectionalLightShader::render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix,
...
bool DirectionalLightShader::initializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename) {
	HRESULT result;
...
void DirectionalLightShader::outputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, const WCHAR* shaderFilename) {
	char* compileErrors;
...
bool DirectionalLightShader::setShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix,
	D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture,
	const Light* light, D3DXVECTOR3 cameraPosition) {
	HRESULT result;
...
void DirectionalLightShader::renderShader(ID3D11DeviceContext* deviceContext, int indexCount) {
...
bool DirectionalLightShader::setFilter(ID3D11Device *device, D3D11_FILTER filterMode) {
	D3D11_SAMPLER_DESC samplerDesc;
