...
bool SkyBoxClass::Initialize(ID3D11Device* device, HWND hwnd, const WCHAR* textureFileName) {
	bool result;
...
bool SkyBoxClass::CreateSphere(ID3D11Device* device, int latLines, int longLines) {
...
bool SkyBoxClass::InitializeShader(ID3D11Device* device, HWND hwnd) {
...
bool SkyBoxClass::LoadTexture(ID3D11Device* device, const WCHAR* fileName) {
...
bool SkyBoxClass::Render(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix,
...
bool SkyBoxClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix,
	D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix) {
...
void SkyBoxClass::RenderShader(ID3D11DeviceContext* deviceContext) {
