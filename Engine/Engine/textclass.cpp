...
bool TextClass::SetCameraPosition(const D3DXVECTOR3& pos, ID3D11DeviceContext* deviceContext)
{
	std::string buffer;
	...
	bool result = UpdateSentence(m_renderInfo[0], buffer.c_str(),
		m_renderInfo[0]->x, m_renderInfo[0]->y, 1.0f, 1.0f, 1.0f, deviceContext);
...
bool TextClass::SetFPS(int fps, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	bool result = UpdateSentence(m_renderInfo[1], buffer.c_str(),
		m_renderInfo[1]->x, m_renderInfo[1]->y, red, green, blue, deviceContext);
	if (!result) return false;
...
bool TextClass::SetCPU(int cpu, ID3D11DeviceContext* deviceContext) {
	...
	// Update the sentence vertex buffer with the new string information.
	bool result = UpdateSentence(m_renderInfo[2], buffer.c_str(),
		m_renderInfo[2]->x, m_renderInfo[2]->y, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetNumOfObjects(int num, ID3D11DeviceContext* deviceContext) {
	...
	// Update the sentence vertex buffer with the new string information.
	bool result = UpdateSentence(m_renderInfo[3], buffer.c_str(),
		m_renderInfo[3]->x, m_renderInfo[3]->y, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result) return false;
...
bool TextClass::SetNumOfPolygons(int num, ID3D11DeviceContext* deviceContext) {
	...
	// Update the sentence vertex buffer with the new string information.
	bool result = UpdateSentence(m_renderInfo[4], buffer.c_str(),
		m_renderInfo[4]->x, m_renderInfo[4]->y, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result) return false;
